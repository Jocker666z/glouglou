...
* `it|mod|mo3|mptm|s3m|stm|stp|plm|xm`
	* openmpt123
	* xmp
	* zxtune
	* mpv
...
* `8svx|acb|acm|ads|adp|adpcm|adx|aix|akb|apc|at3|at9|awb|bcstm|bcwav|bfstm|bfwav|brstm|bwav|cfn|ckd|csb|cmp|csmp|cps|dsm|dsp|dvi|fsb|genh|h4m|hca|hps|ifs|imc|isd|kma|logg|lopus|lstm|lwav|mab|mic|mus|musx|nlsd|nop|npsf|ras|rws|sad|scd|ss2|strm|svag|p04|p16|psb|thp|trk|txtp|vag|vgmstream|wem|xa|xnb|xwv`
	* vgmstream
