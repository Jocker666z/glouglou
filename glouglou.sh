...
ext_vgmstream_0_c="8svx|acb|acm|ads|adp|adpcm|adx|aix|akb|apc|at3|at9|awb|bcstm|bcwav|bfstm|bfwav|brstm|bwav|cfn|ckd|csb|csmp|cps"
ext_vgmstream_d_n="dsm|dsp|dvi|fsb|genh|hca|hps|ifs|imc|kma|logg|lwav|mic|mus|musx|nlsd|nop|npsf"
ext_vgmstream_o_z="rws|sad|scd|ss2|strm|svag|p04|p16|thp|txtp|vag|vgmstream|xa|xnb|xwv"
