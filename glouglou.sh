...
ext_vgmstream_d_n="dsm|dsp|dvi|fsb|genh|h4m|hca|hps|ifs|imc|isd|ivs|kma|lac3|logg|lopus|lstm|lwav|mab|mic|mus|musx|nlsd|nop|npsf"
ext_vgmstream_o_z="ras|rws|sad|scd|sgd|ss2|strm|svag|p04|p16|psb|thp|trk|txtp|ulw|vag|vgmstream|wem|xa|xnb|xwv"
