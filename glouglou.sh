...
ext_vgmstream_0_c="8svx|acm|ads|adp|adpcm|adx|aix|apc|at3|bcstm|bcwav|bfstm|bfwav|brstm|cfn|csb|csmp|cps"
ext_vgmstream_d_n="dsm|dsp|fsb|genh|hca|hps|ifs|imc|kma|lwav|mic|mus|musx|nlsd|nop|npsf"
